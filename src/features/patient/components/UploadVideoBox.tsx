...
export function UploadVideoBox({ videoUrl, fileName, error, onChange }: UploadVideoBoxProps) {
  ...
  return (
    <div className="space-y-3">
      <label
        className={cn(
          "flex min-h-[180px] cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed bg-slate-50 px-4 py-5 text-center transition hover:border-cyan-300 hover:bg-cyan-50/50",
          ...
          <div className="space-y-3">
            ...
            <div>
              <p className="text-sm font-semibold text-slate-800">
                แตะเพื่อเลือกวิดีโอ หรือใช้คลิปที่เพิ่งบันทึก
              </p>
              <p className="mt-1 text-xs text-slate-500">รองรับไฟล์ MP4, MOV หรือ WEBM</p>
            </div>
          </div>
        )}
      </label>
